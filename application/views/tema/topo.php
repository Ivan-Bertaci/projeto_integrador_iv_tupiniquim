...
<body onLoad="initTimer();">
    ...
    <ul>
      ...
      <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vGarantia')) { ?>
        <li class="<?php if (isset($menuGarantia)) {
                        echo 'active';
                      }; ?>"><a href="<?php echo base_url() ?>index.php/garantias"><i class="fas fa-book"></i> <span>Termos de Garantia</span></a></li>
      <?php
      } ?>
  ...
  <!--Footer-part-->
  <div class="row-fluid">
    <div id="footer" class="span12"> <a href="https://www.youtube.com/channel/UCVYXltqnDcOrDytaIMnXusw?sub_confirmation=1">
        <?php echo date('Y'); ?> &copy; Edson Olcheski- Inscreva-se</a></div>
  </div>
  <!--end-Footer-part-->
